...
{ if (src===null) {
                ...
                let assemble_output;
                {
                    ...
                    infix_ops=async function(tokens,ctx,opts) {
                        ...
                        math_op_a=await (async function(){
                            let __targ__73=await first(tokens);
                            if (__targ__73){
                                 return(__targ__73)["name"]
                            } 
                        })();
                        math_op=(await (async function(){
                            let __targ__74=op_translation;
                            if (__targ__74){
                                 return(__targ__74)[math_op_a]
                            } 
                        })()||math_op_a);
                        idx=0;
                        stmts=null;
                        ...
                        if (check_true (is_overloaded)){
                            ...
                            (acc).push("(");
                            await (async function(){
                                 let __test_condition__76=async function() {
                                     return  (idx<((tokens && tokens.length)-1))
                                };
                                let __body_ref__77=async function() {
                                    idx+=1;
                                    token=await (async function(){
                                        let __targ__78=tokens;
                                        if (__targ__78){
                                             return(__targ__78)[idx]
                                        } 
                                    })();
                                    await add_operand();
                                ...
                                let __BREAK__FLAG__=false;
                                while(await __test_condition__76()) {
                                    await __body_ref__77();
                                     if(__BREAK__FLAG__) {
                                         break;
                    ...
                    compile_set_prop=async function(tokens,ctx) {
                        ...
                        complicated=await (async function(){
                            let __array_op_rval__79=is_complex_ques_;
                             if (__array_op_rval__79 instanceof Function){
                                return await __array_op_rval__79((token && token["val"])) 
                            } else {
                                return[__array_op_rval__79,(token && token["val"])]
                            }
                        })();
                        ...
                        await (async function() {
                            ...
                            let __array__83=[],__elements__81=["await"," ","async"," ","function","()","{","let"," ",target_reference,"=",target,";"];
                            let __BREAK__FLAG__=false;
                    ...
                    compile_elem=async function(token,ctx) {
                        let rval;
                        let __check_needs_wrap__89= async function(){
                        ...
                        {
                            rval=null;
                            let check_needs_wrap=await __check_needs_wrap__89();
                            ;
                            if (check_true (await (async function(){
                                let __array_op_rval__94=is_complex_ques_;
                                 if (__array_op_rval__94 instanceof Function){
                                    return await __array_op_rval__94((token && token["val"])) 
                                } else {
                                    return[__array_op_rval__94,(token && token["val"])]
                                }
                            })())){
                    ...
                    compile_inline=async function(tokens,ctx) {
                        ...
                        args=[];
                        await (async function() {
                            let __for_body__98=async function(token) {
                                stmt=await wrap_assignment_value(await compile(token,ctx));
                        ...
                        if (check_true (await verbosity())){
                             await (async function(){
                                let __array_op_rval__100=inline_log;
                                 if (__array_op_rval__100 instanceof Function){
                                    return await __array_op_rval__100("args: ",args) 
                                } else {
                                    return[__array_op_rval__100,"args: ",args]
                                }
                            })()
                        };
                        if (check_true (await (async function(){
                            let __targ__101=(Environment && Environment["inlines"]);
                            if (__targ__101){
                                 return(__targ__101)[(tokens && tokens["0"] && tokens["0"]["name"])]
                            } 
                        })())){
                            inline_fn=await (async function(){
                             ...
                             rval=await (async function(){
                                let __array_op_rval__103=inline_fn;
                                 if (__array_op_rval__103 instanceof Function){
                                    return await __array_op_rval__103(args) 
                                } else {
                                    return[__array_op_rval__103,args]
                                }
                            })()
                    ...
                    compile_push=async function(tokens,ctx) {
                        ...
                        thing=await compile_elem((tokens && tokens["2"]),ctx);
                         return  await (async function(){
                            let __array_op_rval__104=place;
                             if (__array_op_rval__104 instanceof Function){
                                return await __array_op_rval__104(".push","(",thing,")") 
                            } else {
                                return[__array_op_rval__104,".push","(",thing,")"]
                            }
                        })()
                    };
                    compile_list=async function(tokens,ctx) {
                        ...
                        await (async function() {
                            ...
                            let __array__108=[],__elements__106=await tokens["slice"].call(tokens,1);
                            let __BREAK__FLAG__=false;
                    ...
                    compile_instanceof=async function(tokens,ctx) {
                        ...
                        if (check_true (((tokens instanceof Array)&&((tokens && tokens.length)===3)))){
                            let __array_arg__111=(async function() {
                                if (check_true (await (async function(){
                                    let __array_op_rval__109=is_complex_ques_;
                                     if (__array_op_rval__109 instanceof Function){
                                        return await __array_op_rval__109((tokens && tokens["1"])) 
                                    } else {
                                        return[__array_op_rval__109,(tokens && tokens["1"])]
                                    }
                                })())){
                            ...
                            return ["(",await __array_arg__111()," ","instanceof"," ",await __array_arg__112(),")"]
                    ...
                    compile_compare=async function(tokens,ctx) {
                        let acc;
                        let ops;
                        let __operator__113= async function(){
                            return await (async function(){
                                let __targ__116=ops;
                                if (__targ__116){
                                     return(__targ__116)[await (async function(){
                                        let __targ__115=await first(tokens);
                                        if (__targ__115){
                                             return(__targ__115)["name"]
                                        } 
                                    })()]
                                } 
                            })()
                        ...
                        let right;
                        {
                            ...
                            let operator=await __operator__113();
                            ;
                            left=await (async function(){
                                let __targ__117=tokens;
                                if (__targ__117){
                    ...
                    compile_assignment=async function(tokens,ctx) {
                        ...
                        assignment_operator=await (async function(){
                            let __targ__119=await first(tokens);
                            if (__targ__119){
                                 return(__targ__119)["name"]
                            } 
                        })();
                        token=await second(tokens);
                        ...
                        await async function(){
                            let __target_obj__120=ctx;
                            __target_obj__120["in_assignment"]=true;
                        ...
                        if (check_true ((target_location_compile_time==="local"))){
                            ...
                            (acc).push("=");
                             ...
                             await (async function() {
                                let __for_body__123=async function(t) {
                                     return  (acc).push(t)
                                };
                                let __array__124=[],__elements__122=[{
                                    ctype:"statement"
                        ...
                        await async function(){
                            let __target_obj__125=ctx;
                            __target_obj__125["in_assignment"]=false;
                                ...
                                if (check_true( (null==final_stmt))) {
                                    ...
                                    await async function(){
                                        if (check_true( ((await first(flattened) instanceof Object)&&await (async function(){
                                            let __targ__126=await first(flattened);
                                            if (__targ__126){
                                            ...
                                            let __targ__127=await second(flattened);
                                            if (__targ__127){
                    ...
                    compile_toplevel=async function(lisp_tree,ctx,block_options) {
                        if (check_true (await get_ctx_val(ctx,"__IN_LAMBDA__")))throw new EvalError("Compiler attempt to compile top-level in lambda (most likely a bug)");
                         else {
                            {
                                let idx;
                                let rval;
                                let __tokens__128= async function(){
                                    return null
                                };
                                let stmt;
                                let num_non_return_statements;
                                {
                                    idx=0;
                                    rval=null;
                                    let tokens=await __tokens__128();
                                    ;
                                    stmt=null;
                                    ...
                                    await (async function(){
                                         let __test_condition__129=async function() {
                                             return  (idx<num_non_return_statements)
                                        };
                                        let __body_ref__130=async function() {
                                            idx+=1;
                                            if (check_true (await verbosity(ctx))){
                                                  return await (async function(){
                                                    let __array_op_rval__132=top_level_log;
                                                     if (__array_op_rval__132 instanceof Function){
                                                        return await __array_op_rval__132((""+idx+"/"+num_non_return_statements),"->",await (await Environment.get_global("as_lisp"))(await (async function(){
                                                        ...
                                                        return[__array_op_rval__132,(""+idx+"/"+num_non_return_statements),"->",await (await Environment.get_global("as_lisp"))(await (async function(){
                                                            let __targ__131=lisp_tree;
                                                            if (__targ__131){
                                                                 return(__targ__131)[idx]
                                                            } 
                                                  ...
                                                  return await (async function(){
                                                    let __array_op_rval__134=top_level_log;
                                                     if (__array_op_rval__134 instanceof Function){
                                                        return await __array_op_rval__134((""+idx+"/"+num_non_return_statements),"tokens ->",await clone(tokens)) 
                                                    } else {
                                                        return[__array_op_rval__134,(""+idx+"/"+num_non_return_statements),"tokens ->",await clone(tokens)]
                                                    }
                                                })()
                                            };
                                            if (check_true (await verbosity(ctx))){
                                                  return await (async function(){
                                                    let __array_op_rval__135=top_level_log;
                                                     if (__array_op_rval__135 instanceof Function){
                                                        return await __array_op_rval__135((""+idx+"/"+num_non_return_statements),"expand ->",await clone(expanded_tree)) 
                                                    } else {
                                                        return[__array_op_rval__135,(""+idx+"/"+num_non_return_statements),"expand ->",await clone(expanded_tree)]
                                                    }
                                                })()
                                            };
                                        ...
                                        let __BREAK__FLAG__=false;
                                        while(await __test_condition__129()) {
                                            await __body_ref__130();
                                             if(__BREAK__FLAG__) {
                                                 break;
                    ...
                    compile_let=async function(tokens,ctx) {
                                ...
                                if (check_true (ctx_details)){
                                    if (check_true ((await not((ctx_details && ctx_details["is_argument"]))&&((ctx_details && ctx_details["levels_up"])>1)))){
                                        ...
                                        if (check_true (((ctx_details && ctx_details["declared_global"])&&await not((ctx_details && ctx_details["is_argument"]))))){
                                             await async function(){
                                                let __target_obj__179=shadowed_globals;
                                                __target_obj__179[(alloc_set && alloc_set["0"] && alloc_set["0"]["name"])]=true;
                            ...
                            let __body_ref__181=async function() {
                                ...
                                await async function(){
                                    if (check_true( ((alloc_set && alloc_set["1"] && alloc_set["1"]["val"]) instanceof Array))) {
                                        ...
                                        let __targ__186=(Environment && Environment["context"] && Environment["context"]["scope"]);
                                        if (__targ__186){
                                             return(__targ__186)[(alloc_set && alloc_set["1"] && alloc_set["1"]["name"])]
                                        } 
                                    })()&&await not((ctx_details && ctx_details["is_argument"]))&&await (async function(){
                                        let __targ__187=shadowed_globals;
                                        if (__targ__187){
                                             return(__targ__187)[(alloc_set && alloc_set["0"] && alloc_set["0"]["name"])]
                                        } 
                                    })()))) {
                                ...
                                if (check_true ((ctx_details && ctx_details["is_argument"]))){
                                     await async function(){
                                        let __target_obj__188=block_declarations;
                                        __target_obj__188[reference_name]=true;
                                ...
                                await async function(){
                                    if (check_true( (await (async function(){
                                        ...
                                        def_idx+=1;
                                        await async function(){
                                            let __target_obj__192=await (async function(){
                                                let __targ__193=redefinitions;
                                                if (__targ__193){
                                                     return(__targ__193)[reference_name]
                                                } 
                                            })();
                                            __target_obj__192[0]=def_idx;
                                         ...
                                         return  await (async function() {
                                            ...
                                            let __array__197=[],__elements__195=["let"," ",await (async function(){
                                                let __targ__199=await (async function(){
                                        ...
                                        let __targ__200=block_declarations;
                                        if (__targ__200){
                                        ...
                                        await (async function() {
                                            ...
                                            let __array__204=[],__elements__202=["let"," ",reference_name,";"];
                                            let __BREAK__FLAG__=false;
                                         ...
                                         return  await async function(){
                                            let __target_obj__205=block_declarations;
                                            __target_obj__205[reference_name]=true;
                                ...
                                if (check_true (await not(await (async function(){
                                    ...
                                    if (__targ__206){
                                     ...
                                     await async function(){
                                        let __target_obj__207=assignments;
                                        __target_obj__207[reference_name]=[];
                                    ...
                                    if (__targ__208){
                                     ...
                                     if (check_true (def_idx)){
                                          return ["await"," ",await (async function(){
                                            let __targ__210=await (async function(){
                        ...
                        if (check_true (need_sub_block)){
                             await (async function() {
                                let __for_body__213=async function(pset) {
                                     return  await (async function() {
                                        let __for_body__217=async function(redef) {
                                             return  (await (async function(){
                                                let __targ__219=redefinitions;
                                                if (__targ__219){
                                                     return(__targ__219)[(pset && pset["0"])]
                                                } 
                                            })()).shift()
                                        };
                                        let __array__218=[],__elements__216=(pset && pset["1"]);
                                        let __BREAK__FLAG__=false;
                                ...
                                let __array__214=[],__elements__212=await (await Environment.get_global("pairs"))(redefinitions);
                                let __BREAK__FLAG__=false;
                        ...
                        await (async function(){
                            ...
                            let __body_ref__221=async function() {
                                ...
                                stmt=[];
                                alloc_set=await (async function(){
                                    let __targ__223=await (async function(){
                                        let __targ__222=allocations;
                                        if (__targ__222){
                                             return(__targ__222)[idx]
                                        } 
                                    })();
                                    if (__targ__223){
                                         return(__targ__223)["val"]
                                    } 
                                })();
                                reference_name=await clean_quoted_reference(await sanitize_js_ref_name((alloc_set && alloc_set["0"] && alloc_set["0"]["name"])));
                                ctx_details=await get_declaration_details(ctx,reference_name);
                                assignment_value=(await (async function(){
                                    let __targ__224=assignments;
                                    if (__targ__224){
                                ...
                                await async function(){
                                    if (check_true( await (async function(){
                                        let __targ__225=block_declarations;
                                        if (__targ__225){
                                ...
                                await async function(){
                                    let __target_obj__226=block_declarations;
                                    __target_obj__226[reference_name]=true;
                        ...
                        await (async function() {
                            let __for_body__229=async function(i) {
                                 return  (acc).push("}")
                            };
                            let __array__230=[],__elements__228=await (await Environment.get_global("range"))(sub_block_count);
                            let __BREAK__FLAG__=false;
                    ...
                    compile_fn=async function(tokens,ctx,fn_opts) {
                        ...
                        let arg;
                        let fn_args;
                        let __body__231= async function(){
                    ...
                    compile_jslambda=async function(tokens,ctx) {
                        let acc;
                        let fn_args;
                        let __body__245= async function(){
                        ...
                        let type_mark;
                        {
                            ...
                            await (async function() {
                                ...
                                let __array__249=[],__elements__247=["new"," ","Function","("];
                                let __BREAK__FLAG__=false;
                            ...
                            await (async function(){
                                 let __test_condition__250=async function() {
                                     return  (idx<((fn_args && fn_args.length)-1))
                                };
                                let __body_ref__251=async function() {
                                    idx+=1;
                                    arg=await (async function(){
                                        let __targ__252=fn_args;
                                        if (__targ__252){
                                             return(__targ__252)[idx]
                                        } 
                                    })();
                                    await set_ctx(ctx,(arg && arg.name),ArgumentType);
                                ...
                                let __BREAK__FLAG__=false;
                                while(await __test_condition__250()) {
                                    await __body_ref__251();
                                     if(__BREAK__FLAG__) {
                                         break;
                            ...
                            (acc).push("\"");
                            await (async function() {
                                let __for_body__255=async function(c) {
                                ...
                                let __array__256=[],__elements__254=(body).split("");
                                let __BREAK__FLAG__=false;
                        ...
                        acc=await (async function ()  {
                            let __array_arg__478=(async function() {
                                if (check_true ((Function===await (async function(){
                                    let __targ__477=(root_ctx && root_ctx["defined_lisp_globals"]);
                                    if (__targ__477){
                                         return(__targ__477)[target]
                                    } 
                                })()))){
                                      return ""
                                } else {
     ...
     return  await Environment["set_compiler"].call(Environment,(await Environment.get_global("compiler")))
}
}
