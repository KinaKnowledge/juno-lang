...
export async function init_dlisp(Environment)  {
{
  ...
  return typeof value;
                    ...
                    await async function(){
                        ...
                        __target_obj__5["__VERBOSITY__"]=__VERBOSITY__;
                        return __target_obj__5;
                        
                    }();
                    [await async function(){
                        let __target_obj__6=Environment.definitions;
                        __target_obj__6["__VERBOSITY__"]={
                    ...
                    let jslambda=function(...args) {
                         return   ( function(){
                            let __apply_args__40= flatten(args);
                    ...
                    let describe=async function(quoted_symbol) {
                        ...
                        location=await async function(){
                            if (check_true( await (async function(){
                                let __targ__78=Environment.global_ctx.scope;
                                if (__targ__78){
                        ...
                        result=await (await get_global("add"))({
                            type:await async function(){
                             ...
                             if (check_true (await (async function(){
                                let __targ__80=Environment.definitions;
                                if (__targ__80){
                        ...
                        if (check_true (result.description)){
                             await async function(){
                                let __target_obj__82=result;
                                __target_obj__82["description"]=await Environment["eval"].call(Environment,result.description);
                    ...
                    ;
                    await async function(){
                        let __target_obj__83=Environment.global_ctx.scope;
                        __target_obj__83["describe"]=describe;
                        return __target_obj__83;
                        
                    }();
                    let undefine=function(quoted_symbol) {
                        if (check_true ( ( function(){
                            let __targ__84=Environment.global_ctx.scope;
                            if (__targ__84){
                                 return(__targ__84)[quoted_symbol]
                            } 
                        })())){
                    ...
                    await async function(){
                        ...
                        __target_obj__85["undefine"]=undefine;
                    ...
                    let eval_exp=async function(expression) {
                        await console.log("EVAL:",expression);
                         return  await (async function(){
                            let __array_op_rval__86=expression;
                    ...
                    await async function(){
                        ...
                        __target_obj__87["eval_exp"]=eval_exp;
                    ...
                    await async function(){
                        ...
                        __target_obj__88["indirect_new"]=indirect_new;
                    ...
                    let range=function(...args) {
                        ...
                        acc=[];
                         ( function(){
                             let __test_condition__89=function() {
                                 return  (idx<from_to['1'])
                            };
                            let __body_ref__90=function() {
                                (acc).push(idx);
                                 return  idx+=step
                            };
                            let __BREAK__FLAG__=false;
                            while( __test_condition__89()) {
                                 __body_ref__90();
                                 if(__BREAK__FLAG__) {
                                     break;
                    ...
                    ;
                    await async function(){
                        let __target_obj__91=Environment.global_ctx.scope;
                        __target_obj__91["range"]=range;
                    ...
                    await async function(){
                        ...
                        __target_obj__93["merge_objects"]=merge_objects;
                    ...
                    await async function(){
                        ...
                        __target_obj__94["index_of"]=index_of;
                    ...
                    await async function(){
                        ...
                        __target_obj__95["resolve_path"]=resolve_path;
                    ...
                    await async function(){
                        ...
                        __target_obj__96["delete_prop"]=delete_prop;
                    ...
                    await async function(){
                        ...
                        __target_obj__97["min_value"]=min_value;
                    ...
                    await async function(){
                        ...
                        __target_obj__98["max_value"]=max_value;
                    ...
                    let interlace=async function(...args) {
                        ...
                        rval=[];
                        await (async function() {
                            let __for_body__101=async function(i) {
                                 return  await (async function() {
                                    let __for_body__105=async function(j) {
                                         return  (rval).push(await (async function(){
                                            let __targ__108=await (async function(){
                                                let __targ__107=args;
                                                if (__targ__107){
                                                     return(__targ__107)[j]
                                                } 
                                            })();
                                            if (__targ__108){
                                                 return(__targ__108)[i]
                                            } 
                                        })())
                                    };
                                    let __array__106=[],__elements__104=rlength_args;
                                    let __BREAK__FLAG__=false;
                            ...
                            let __array__102=[],__elements__100=await range(min_length);
                            let __BREAK__FLAG__=false;
                    ...
                    ;
                    await async function(){
                        let __target_obj__109=Environment.global_ctx.scope;
                        __target_obj__109["interlace"]=interlace;
                        return __target_obj__109;
                        
                    }();
                    [await async function(){
                        let __target_obj__110=Environment.definitions;
                        __target_obj__110["interlace"]={
                    ...
                    await async function(){
                        ...
                        __target_obj__112["assert"]=assert;
                        return __target_obj__112;
                        
                    }();
                    [await async function(){
                        let __target_obj__113=Environment.definitions;
                        __target_obj__113["assert"]={
                    ...
                    let or_args=async function(argset) {
                        ...
                        await (async function() {
                            ...
                            let __array__119=[],__elements__117=argset;
                            let __BREAK__FLAG__=false;
                    ...
                    ;
                    await async function(){
                        let __target_obj__120=Environment.global_ctx.scope;
                        __target_obj__120["or_args"]=or_args;
                    ...
                    await async function(){
                        ...
                        __target_obj__121["special_operators"]=special_operators;
                    ...
                    let defclog=async function(opts) {
                        ...
                        style=("padding: 5px;"+await (async function () {
                         ...
                         return  async function(...args) {
                             return  await (async function(){
                                let __target_arg__124=[].concat(await conj(await (async function(){
                                    let __array_op_rval__125=style;
                                ...
                                if(!__target_arg__124 instanceof Array){
                                    throw new TypeError("Invalid final argument to apply - an array is required")
                                }let __pre_arg__126=("%c"+await (async function () {
                                ...
                                __target_arg__124.unshift(__pre_arg__126);
                                return (console.log).apply(this,__target_arg__124)
                            })()
                        }
                    };
                    ;
                    await async function(){
                        let __target_obj__127=Environment.global_ctx.scope;
                        __target_obj__127["defclog"]=defclog;
                    ...
                    await async function(){
                        ...
                        __target_obj__128["NOT_FOUND"]=NOT_FOUND;
                    ...
                    await async function(){
                        ...
                        __target_obj__129["check_external_env_default"]=check_external_env_default;
                    ...
                    let set_global=function(refname,value,meta) {
                        {
                              ...
                              (function(){
                                ...
                                __target_obj__130[refname]=value;
                                return __target_obj__130;
                                
                            })();
                            if (check_true (((meta instanceof Object)&& not((meta instanceof Array))))){
                                   (function(){
                                    let __target_obj__131=Environment.definitions;
                                    __target_obj__131[refname]=meta;
                                    return __target_obj__131;
                                    
                                })()
                            };
                             return   ( function(){
                                let __targ__132=Environment.global_ctx.scope;
                                if (__targ__132){
                                     return(__targ__132)[refname]
                                } 
                            })()
                        }
                    };
                    ;
                    await async function(){
                        let __target_obj__133=Environment.global_ctx.scope;
                        __target_obj__133["set_global"]=set_global;
                                ...
                                if (check_true (((undefined===refval)&&check_external_env))){
                                     refval= ( function () {
                                         if (check_true (check_external_env)){
                                              return ( ( function(){
                                                let __targ__135=Environment.externs;
                                                if (__targ__135){
                    ...
                    ;
                    await async function(){
                        let __target_obj__136=Environment.global_ctx.scope;
                        __target_obj__136["get_global"]=get_global;
                    ...
                    await async function(){
                        ...
                        __target_obj__137["compile"]=compile;
                        return __target_obj__137;
                        
                    }();
                    [await async function(){
                        let __target_obj__138=Environment.definitions;
                        __target_obj__138["compile"]={
                    ...
                    await async function(){
                        ...
                        __target_obj__139["env_log"]=env_log;
                    ...
                    let evaluate=async function(expression,ctx,opts) {
                                      ...
                                      if (__exception__140 instanceof Error) {
                                         let e=__exception__140;
                                         {
                                            if (check_true (opts.error_report)){
                                                  return await (async function(){
                                                    let __array_op_rval__141=opts.error_report;
                        ...
                        if (check_true (opts.on_compilation_complete)){
                             await (async function(){
                                let __array_op_rval__142=opts.on_compilation_complete;
                                 if (__array_op_rval__142 instanceof Function){
                                    return await __array_op_rval__142(compiled) 
                                } else {
                                    return[__array_op_rval__142,compiled]
                                }
                            })()
                        };
                        await (async function(){
                            try /* TRY COMPLEX */ {
                                 return  result=await async function(){
                                    if (check_true(compiled.error)) {
                                         ...
                                         if (check_true (await (async function(){
                                            let __array_op_rval__144=compiled['0'].has_lisp_globals;
                                            ...
                                            await async function(){
                                                let __target_obj__145=compiled;
                                                __target_obj__145[1]=new AsyncFunction("Environment",("{ "+compiled['1']+"}"));
                                                return __target_obj__145;
                                                
                                            }();
                                             return  await (async function(){
                                                let __array_op_rval__146=compiled['1'];
                                                 if (__array_op_rval__146 instanceof Function){
                                                    return await __array_op_rval__146(Environment) 
                                                } else {
                                                    return[__array_op_rval__146,Environment]
                                                }
                                            })()
                                        } else {
                                            await async function(){
                                                let __target_obj__147=compiled;
                                                __target_obj__147[1]=new AsyncFunction(("{"+compiled['1']+"}"));
                                        ...
                                        if (check_true (await (async function(){
                                            let __array_op_rval__149=compiled['0'].has_lisp_globals;
                                            ...
                                            await async function(){
                                                let __target_obj__150=compiled;
                                                __target_obj__150[1]=new AsyncFunction("Environment",("{ return "+compiled['1']+"} "));
                                                return __target_obj__150;
                                                
                                            }();
                                             return  await (async function(){
                                                let __array_op_rval__151=compiled['1'];
                                                 if (__array_op_rval__151 instanceof Function){
                                                    return await __array_op_rval__151(Environment) 
                                                } else {
                                                    return[__array_op_rval__151,Environment]
                                                }
                                            })()
                                        } else {
                                            await async function(){
                                                let __target_obj__152=compiled;
                                                __target_obj__152[1]=new AsyncFunction(("{ return "+compiled['1']+"}"));
                                        ...
                                        if (check_true (await (async function(){
                                            let __array_op_rval__154=compiled['0'].has_lisp_globals;
                                            ...
                                            await async function(){
                                                let __target_obj__155=compiled;
                                                __target_obj__155[1]=new Function("Environment",("{ return "+compiled['1']+"} "));
                                                return __target_obj__155;
                                                
                                            }();
                                             return  await (async function(){
                                                let __array_op_rval__156=compiled['1'];
                                                 if (__array_op_rval__156 instanceof Function){
                                                    return await __array_op_rval__156(Environment) 
                                                } else {
                                                    return[__array_op_rval__156,Environment]
                                                }
                                            })()
                                        } else {
                                            await async function(){
                                                let __target_obj__157=compiled;
                                                __target_obj__157[1]=new Function(("{ return "+compiled['1']+"}"));
                            ...
                            }  catch(__exception__143) {
                                  if (__exception__143 instanceof Error) {
                                     let e=__exception__143;
                                     {
                                        await env_log("caught error: ",e.name,e.message);
                                        if (check_true (opts.error_report)){
                                             await (async function(){
                                                let __array_op_rval__159=opts.error_report;
                    ...
                    ;
                    await async function(){
                        let __target_obj__160=Environment.global_ctx.scope;
                        __target_obj__160["evaluate"]=evaluate;
                    ...
                    let eval_struct=async function(lisp_struct,ctx,opts) {
                        ...
                        if (check_true (lisp_struct instanceof Function)){
                             rval=await (async function(){
                                let __array_op_rval__161=lisp_struct;
                    ...
                    ;
                     await async function(){
                        ...
                        __target_obj__162["eval_struct"]=eval_struct;
                    ...
                    let meta_for_symbol=async function(quoted_symbol) {
                        if (check_true (await (await get_global("starts_with?"))("=:",quoted_symbol))){
                              return await (async function(){
                                let __targ__163=Environment.definitions;
                                if (__targ__163){
                                     return(__targ__163)[await quoted_symbol["substr"].call(quoted_symbol,2)]
                                } 
                            })()
                        } else {
                              return await (async function(){
                                let __targ__164=Environment.definitions;
                                if (__targ__164){
                                     return(__targ__164)[quoted_symbol]
                                } 
                            })()
                        }
                    };
                    ...
                    let set_compiler=async function(compiler_function) {
                        ...
                        await async function(){
                            ...
                            __target_obj__166["compiler"]=compiler;
                    ...
                    ;
                    await async function(){
                        let __target_obj__167=Environment.global_ctx.scope;
                        __target_obj__167["set_compiler"]=set_compiler;
                        return __target_obj__167;
                        
                    }();
                    await async function(){
                        let __target_obj__168=Environment.global_ctx.scope;
                        __target_obj__168["clone"]=async function(val) {
        ...
        if (check_true( (undefined==text))) {
            ...
            debugmode=await (async function () {
                 if (check_true (((await Environment.get_global("__VERBOSITY__"))>6))){
                      return true
                } else {
                      return false
                } 
            ...
            error=async function(type,message,offset) {
                throw new SyntaxError(await JSON.stringify({
                        ...
                        await async function(){
                            if (check_true( ((c==="\n")&&(mode===in_comment)))) {
                                ...
                                handler=await (async function(){
                                    let __targ__23=(handler_stack).pop();
                                    if (__targ__23){
                                         return(__targ__23)[1]
                                    } 
                                })();
                                block_return=await (async function(){
                                    let __array_op_rval__24=handler;
                                     if (__array_op_rval__24 instanceof Function){
                                        return await __array_op_rval__24(block_return) 
                                    } else {
                                        return[__array_op_rval__24,block_return]
                                    }
                                })();
        ...
        if (check_true (((comps && comps.length)===1))){
            ...
            if (check_true( (type===0))) {
                 ...
                 return "=:)"
                    ...
                    let inlines=await add(new Object(),await (async function() {
                        ...
                        __obj__171["bindf"]=async function(args) {
                             return  await (async function(){
                                let __array_op_rval__172=args['0'];
                                 if (__array_op_rval__172 instanceof Function){
                                    return await __array_op_rval__172(".bind(",args['1'],")") 
                                } else {
                                    return[__array_op_rval__172,".bind(",args['1'],")"]
                                }
                            })()
                        };
                             ...
                             return  await (async function(){
                                let __array_op_rval__173=args['0'];
                                 if (__array_op_rval__173 instanceof Function){
                                    return await __array_op_rval__173(" instanceof Function") 
                                } else {
                                    return[__array_op_rval__173," instanceof Function"]
                                }
                            })()
                        };
                             ...
                             return  await (async function(){
                                let __array_op_rval__174=args['0'];
                                 if (__array_op_rval__174 instanceof Function){
                                    return await __array_op_rval__174(" instanceof Element") 
                                } else {
                                    return[__array_op_rval__174," instanceof Element"]
                                }
                            })()
                        };
                    ...
                    ;
                    await async function(){
                        let __target_obj__177=Environment;
                        __target_obj__177["eval"]=eval_struct;
                        __target_obj__177["identify"]=subtype;
                        __target_obj__177["meta_for_symbol"]=meta_for_symbol;
                        __target_obj__177["set_compiler"]=set_compiler;
                        __target_obj__177["read_lisp"]=reader;
                        __target_obj__177["as_lisp"]=as_lisp;
                        __target_obj__177["inlines"]=inlines;
                        __target_obj__177["special_operators"]=special_operators;
                        __target_obj__177["definitions"]=Environment.definitions;
                        __target_obj__177["declarations"]=Environment.declarations;
                        __target_obj__177["compile"]=compile;
                        __target_obj__177["evaluate"]=evaluate;
                        __target_obj__177["do_deferred_splice"]=do_deferred_splice;
                        __target_obj__177["id"]=async function() {
                             return  id
                        };
                        __target_obj__177["set_check_external_env"]=async function(state) {
                            check_external_env_default=state;
                             return  check_external_env_default
                        };
                        __target_obj__177["check_external_env"]=async function() {
                             return  check_external_env_default
                        };
         ...
         return  await (async function(){
            let __targ__178=globalThis;
            if (__targ__178){
                 return(__targ__178)[symname]
            } 
        })()
    }
}
