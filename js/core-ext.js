...
await Environment.set_global("COPY_DATA",null,{
    requires:[],externals:["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","Promise","FileReader","Blob"],source_name:"core-ext.lisp"
});
...
await Environment.set_global("hide",async function(value) {
    return undefined
},{ "name":"hide","fn_args":"(value)","requires":[],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","Promise","FileReader","Blob"],"source_name":"core-ext.lisp"
});
...
}]],true]],"requires":["resolve_path"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","Promise","FileReader","Blob"],"source_name":"core-ext.lisp"
});
...
await Environment.set_global("unload_core_ext",async function() {
    ...
    return count
},{ "name":"unload_core_ext","fn_args":"[]","requires":["log"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","Promise","FileReader","Blob"],"source_name":"core-ext.lisp"
});
