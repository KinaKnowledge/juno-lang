...
await Environment.set_global("COPY_DATA",null,{
    requires:[],externals:["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],source_name:"core-ext.lisp"
});
...
await Environment.set_global("reorder_keys",async function(key_list,obj) {
    ...
    };
    {
        ...
        return await (await Environment.get_global("to_object"))(await (async function(){
             return await (await Environment.get_global("pairs_from_list"))(await (async function(){
...
await Environment.set_global("hide",async function(value) {
    return undefined
},{ "name":"hide","fn_args":"(value)","requires":[],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],"source_name":"core-ext.lisp"
});
    ...
    return await (await Environment.get_global("no_empties"))(await (async function(){
         return await (await Environment.get_global("map"))(async function(x,i) {
            if (check_true ((0===(i% 2)))){
             ...
             return await (await Environment.get_global("words_and_quotes"))(text_string) 
        })()) 
    })())
                ...
                return (await (await Environment.get_global("replace"))(colon_reg,":",v)).split(":")
                 ...
                 return await (await Environment.get_global("map"))(async function(v) {
                    return (await (await Environment.get_global("replace"))(semi_reg,";",v)).split(";")
                     ...
                     return await (await Environment.get_global("words_and_quotes"))(text) 
                })()) 
            })())) 
        })()) 
    })())
...
await Environment.set_global("yesterday",async function() {
    ...
    d1=new Date();
    d2=new Date();
    return [await (await Environment.get_global("clear_time"))(await (async function(){
         return await (await Environment.get_global("add_days"))(d1,-1) 
    })()),await (async function(){
         return await (await Environment.get_global("set_hours"))(await (async function(){
             return await (await Environment.get_global("clear_time"))(await (async function(){
                 return await (await Environment.get_global("add_days"))(d2,-1) 
            })()) 
        })(),24) 
    })()]
...
await Environment.set_global("next_sunday",async function(dval) {
    ...
    ;
    return await (await Environment.get_global("clear_time"))(await (async function(){
         return await (await Environment.get_global("add_days"))(dv,(7- await (async function(){
             return await (await Environment.get_global("day_of_week"))(dv) 
        })())) 
    })())
...
await Environment.set_global("last_sunday",async function(dval) {
    ...
    ;
    return await (await Environment.get_global("clear_time"))(await (async function(){
         return await (await Environment.get_global("add_days"))(dv,(-1* await (async function(){
             return await (await Environment.get_global("day_of_week"))(dv) 
        })())) 
    })())
...
await Environment.set_global("day_before_yesterday",async function() {
    let d1;
    let d2;
    d1=await (async function(){
         return await (await Environment.get_global("clear_time"))(await (async function(){
             return await (await Environment.get_global("add_days"))(new Date(),-2) 
        })()) 
    })();
    d2=await (async function(){
         return await (await Environment.get_global("clear_time"))(await (async function(){
             return await (await Environment.get_global("add_days"))(new Date(),-1) 
        })()) 
    })();
    return await (async function(){
...
await Environment.set_global("last_week",async function() {
    ...
    d2=new Date();
    return [await (await Environment.get_global("clear_time"))(await (async function(){
         return await (await Environment.get_global("add_days"))(await (async function(){
             return await (await Environment.get_global("next_sunday"))() 
        })(),-14) 
    })()),await (async function(){
         return await (await Environment.get_global("last_sunday"))() 
    })()]
...
await Environment.set_global("midnight-to-midnight",async function(dval) {
    ...
    let d2;
    d1=await (async function(){
         return await (await Environment.get_global("clear_time"))(new Date(dval)) 
    })();
    d2=await (async function(){
         return await (await Environment.get_global("clear_time"))(new Date(dval)) 
    })();
    return await (async function(){
        let __array_op_rval__95=d1;
         if (__array_op_rval__95 instanceof Function){
            return await __array_op_rval__95(await (async function(){
                 return await (await Environment.get_global("set_hours"))(d2,24) 
            })()) 
        } else {
            return [__array_op_rval__95,await (async function(){
                 return await (await Environment.get_global("set_hours"))(d2,24) 
            })()]
        }
    })()
...
await (async function(){
    return  Environment.set_global("to_date",function(value) {
        return   (function(){
            if (check_true ((value instanceof String || typeof value==='string'))) {
                {
                    let dval;
                    dval=new Date(value);
                    if (check_true (( dval["toString"]()==="Invalid Date"))){
                        throw new RangeError("to_date: invalid format");
                        
                    };
                    return dval
                }
            } else if (check_true ( ( Environment.get_global("is_number?"))(value))) {
                return new Date(value)
            } else if (check_true ( ( function(){
                 return  ( Environment.get_global("is_date?"))(value) 
            })())) {
                return value
            } else {
                throw new TypeError(("to_date:invalid value type: "+  ( Environment.get_global("sub_type"))(value)));
                
            }
        } )()
    },{ "name":"to_date","fn_args":"(value)","description":["=:+","<br><br>Given an input value that is of type string, Number or Date, returns a ","Date object.<br>When providing a numeric input, the number will be considered ","to be the milliseconds from the epoch, defined as the midnight at the beginning ","of January 1, 1970, UTC.<br>If given a string object, the value is assumed to ","be in the date time string format, which is a simplification of the ISO 8601  ","calendar date extended format.   The format ","is:```YYYY-MM-DDTHH:mm:ss.sssZ```<br><br>Where:<br>`YYYY`  is a four digit ","year<br>`MM`  is a two digit month `(01-12)` <br>`DD`  is the day of the ","month `(01-31)` <br>`T`  is a literal character, separating the date from the ","time segment.<br>`HH`  is a two difit hour `(00-23)` <br>`mm`  is the two digit ","minute `(00-59)` <br>`ss`  is the two digit second `(00-59)` <br>`sss` is the ","three digit millisecond `(000-999)` <br>`Z` is the literal timezone separator, ","which is followed by a positive or negative offset, with a `+` or `-` followed ","by `HH:mm` indicating the offset time from UTC.<br>The provided date can be ","specified in various increasing granularities.  All are ","valid:<br>`YYYY` <br>`YYYY-MM` <br>`YYYY-MM-DD`<br><br> "],"tags":["date","time","conversion","string","number","milliseconds","convert"],"usage":["value:string|number|Date"],"requires":["is_string?","is_number?","is_date?","sub_type"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],"source_name":"core-ext.lisp"
})
})();
...
await Environment.set_global("demarked_number",async function(value,separator,precision,no_show_sign) {
    ...
    if (check_true ((l>3))){
        await (async function() {
            let __for_body__109=async function(p) {
                return await comps["splice"].call(comps,p,0,sep)
            };
            let __array__110=[],__elements__108=(await (await Environment.get_global("range"))(3,l,3)).slice(0).reverse();
            let __BREAK__FLAG__=false;
...
await Environment.set_global("text_to_rgb",async function(rgb_string) {
    if (check_true (rgb_string)){
        return await (async function(){
            let __array_op_rval__115=(await parseInt((await (async function(){
                 return await (await Environment.get_global("nth"))([0,1],rgb_string) 
            })()).join(''),16)/ 255);
             if (__array_op_rval__115 instanceof Function){
                return await __array_op_rval__115((await parseInt((await (async function(){
                ...
                return [__array_op_rval__115,(await parseInt((await (async function(){
                     return await (await Environment.get_global("nth"))([2,3],rgb_string) 
                })()).join(''),16)/ 255),(await parseInt((await (async function(){
                     return await (await Environment.get_global("nth"))([4,5],rgb_string) 
                })()).join(''),16)/ 255)]
    ...
    if (check_true (rgb)){
        {
            ...
            computedV=maxRGB;
            return await (async function(){
                let __array_op_rval__117=computedH;
                 if (__array_op_rval__117 instanceof Function){
                    return await __array_op_rval__117(computedS,computedV) 
                } else {
                    return [__array_op_rval__117,computedS,computedV]
                }
            })()
        }
    }
...
await Environment.set_global("camel_case_to_lower",async function(val) {
    ...
    return (await (async function(){
         return await (await Environment.get_global("map"))(async function(v,i) {
            return await async function(){
                if (check_true (((i>0)&& await (async function(){
                     return await (await Environment.get_global("is_upper?"))(v) 
                })()&& (0===last_upper)))) {
                    {
                        last_upper=1;
                        return ("_"+ (v).toLowerCase())
                    }
                } else if (check_true (((i>0)&& await (async function(){
                     return await (await Environment.get_global("is_upper?"))(v) 
                })()&& (last_upper>0)))) {
                    {
                        last_upper=2;
                    ...
                    return (v).toLowerCase()
                     ...
                     return await (await Environment.get_global("is_lower?"))(v) 
                })())) {
                    {
                        return await async function(){
...
await Environment.set_global("scan_list",async function(regex,container) {
    ...
    await (async function() {
        ...
        let __array__129=[],__elements__127=(container|| []);
        let __BREAK__FLAG__=false;
...
await Environment.set_global("sum_up_prop",async function(key,values) {
    return await (async function(){
        let __apply_args__130=await (await Environment.get_global("flatten"))(await (async function(){
             return await (await Environment.get_global("gather_up_prop"))(key,values) 
        })());
        return ( (await Environment.get_global("add"))).apply(this,__apply_args__130)
    })()
},{ "name":"sum_up_prop","fn_args":"(key values)","usage":["key:string","values:array|object"],"description":"Given a key and an object or array of objects, return the total sum amount of the given key.","tags":["sum","key","property","objects","iteration"],"requires":["add","flatten","gather_up_prop"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],"source_name":"core-ext.lisp"
});
await Environment.set_global("scan_for",async function(non_nil_prop,list_of_objects) {
    let rval=null;
    ;
    await (async function() {
        let __for_body__134=async function(val) {
        ...
        let __array__135=[],__elements__133=(list_of_objects|| []);
        let __BREAK__FLAG__=false;
                ...
                if (check_true (place)){
                    ...
                    await async function(){
                        buckets[category]=await (async function(){
                            let __array_op_rval__137=thing;
...
await Environment.set_global("tokenize_delimited_text",async function(text,options) {
    let delimiter;
    let escaped;
    let in_quotes;
    let ccode;
    ...
    (acc).push((await (async function(){
        let __targ__138=(rval).pop();
        if (__targ__138){
             return(__targ__138)["text"]
        } 
    })()|| ""));
...
await Environment.set_global("unload_core_ext",async function() {
    ...
    return count
},{ "name":"unload_core_ext","fn_args":"[]","requires":["log"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],"source_name":"core-ext.lisp"
});
...
await Environment.set_global("cksum",async function(data,algorithm) {
    let result;
    algorithm=(algorithm|| "SHA-256");
    result=null;
    data=await (async function(){
         return await async function(){
            if (check_true ((data instanceof String || typeof data==='string'))) {
                return await (async function() {
                    {
                         let __call_target__=new TextEncoder(), __call_method__="encode";
                        return await __call_target__[__call_method__].call(__call_target__,data)
                    } 
                })()
            } else if (check_true (("ArrayBuffer"===await (await Environment.get_global("sub_type"))(data)))) {
                return data
            } else {
                throw new RangeError("cksum: data must be string or an ArrayBuffer");
                
            }
        } () 
    })();
    result=await crypto.subtle["digest"].call(crypto.subtle,algorithm,data);
    if (check_true ((await (await Environment.get_global("sub_type"))(result)==="ArrayBuffer"))){
        return (await (async function(){
             return await (await Environment.get_global("map"))(async function(b) {
                return await (async function() {
                    {
                         let __call_target__=await b["toString"].call(b,16), __call_method__="padStart";
                        return await __call_target__[__call_method__].call(__call_target__,2,"0")
                    } 
                })()
            },await Array["from"].call(Array,new Uint8Array(result))) 
        })()).join("")
    } else {
        throw new Error("cksum: unable to digest provided data");
        
    }
},{ "name":"cksum","fn_args":"(data algorithm)","description":["=:+","The `cksum` function returns a digest string for a ","given `string` or `ArrayBuffer` .  An optional algorithm argument can be ","provided which should be one of the values allowed by ","the `SubtleCrypto` library.  These are `SHA-1` , `SHA-256` , `SHA-384` , ","and `SHA-512` .  `SHA-256` is the default, if the specific algorithm to use ","isn't provided.<br>Example:```(cksum \"The quick brown fox jumped over the lazy ","dog.\")```<br><br>Returns:```\"68b1282b91de2c054c36629cb8dd447f12f096d3e3c587978dc2248444633483\"```<br>"],"usage":["data:string|ArrayBuffer","algorithm:string"],"tags":["crypto","digest","checksum","string","ArrayBuffer"],"requires":["is_string?","sub_type","join","map"],"externals":["ReferenceError","Object","Date","Math","Error","RegExp","Function","parseFloat","clone","TextEncoder","crypto","DataView","TypeError","subtype","isNaN","RangeError","Intl","parseInt","console","Promise","FileReader","Blob","Array","Uint8Array"],"source_name":"core-ext.lisp"
});
