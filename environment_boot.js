...
export async function environment_boot(Environment) {

  {
    ...
    await (async function ()  {
         return  await Environment.set_global("macroexpand",async function(quoted_form) {
            let macro_name;
            let macro_func;
            let expansion;
    ...
    await (async function ()  {
         return  await Environment.set_global("get_object_path",async function(refname) {
            let length=function anonymous(obj) {
{
    ...
    await (async function ()  {
         return  await Environment.set_global("do_deferred_splice",async function(tree) {
            let rval;
            let idx;
            let tval;
    ...
    await (async function ()  {
         return  await Environment.set_global("type",async function(x) {
             return  await async function(){
    ...
    await (async function ()  {
         return  await Environment.set_global("destructure_list",async function(elems) {
            let idx;
            let acc;
            let structure;
            let follow_tree;
    ...
    await (async function ()  {
         return  await Environment.set_global("is_nil?",async function(value) {
             return  (null===value)
    ...
    await (async function ()  {
         return  await Environment.set_global("is_regex?",async function(x) {
    ...
    await (async function ()  {
         return  await Environment.set_global("scan_str",async function(regex,search_string) {
            let result;
            let last_result;
            let totals;
            let strs;
    ...
    await (async function ()  {
         return  await Environment.set_global("remove_prop",async function(obj,key) {
    ...
    await (async function ()  {
         return  await Environment.set_global("object_methods",async function(obj) {
            let properties;
            let current_obj;
            properties=new Set();
            current_obj=obj;
    ...
    await (async function ()  {
         return  await Environment.set_global("expand_dot_accessor",async function(val,ctx) {
            let comps;
            let find_in_ctx;
            let reference;
            let val_type;
    ...
    await (async function ()  {
         return  await Environment.set_global("getf_ctx",async function(ctx,name,_value) {
    ...
    await (async function ()  {
         return  await Environment.set_global("setf_ctx",async function(ctx,name,value) {
            let found_val;
    ...
    await (async function ()  {
         return  await Environment.set_global("set_path",async function(path,obj,value) {
            let fpath;
            let idx;
            let rpath;
            let target_obj;
    ...
    await (async function ()  {
         return  await Environment.set_global("minmax",async function(container) {
            let value_found;
            let smallest;
            let biggest;
            value_found=false;
    ...
    await (async function ()  {
         return  await Environment.set_global("gen_multiples",async function(len,multiple_ques_) {
            let val;
            let acc;
            let mult;
            val=100;
    ...
    await (async function ()  {
         return  await Environment.set_global("path_multiply",async function(path,multiple_ques_) {
            let acc;
            let multiples;
            acc=0;
    ...
    await (async function ()  {
         return  await Environment.set_global("splice_in_return_b",async function(js_tree,_ctx,_depth) {
             return  await async function(){
                if (check_true( (js_tree instanceof Array))) {
                    let idx;
                    let ntree;
    ...
    await (async function ()  {
         return  await Environment.set_global("map_range",async function(n,from_range,to_range) {
    ...
    await (async function ()  {
         return  await Environment.set_global("color_for_number",async function(num,saturation,brightness) {
            let h;
            let pos;
            let color_key;
            let rgb;
    ...
    await (async function ()  {
         return  await Environment.set_global("flatten_ctx",async function(ctx,_var_table) {
            let var_table;
            let ctx_keys;
    ...
    await (async function ()  {
         return  await Environment.set_global("identify_symbols",async function(quoted_form,_state) {
            let acc;
            acc=[];
    ...
    await (async function ()  {
         return  await Environment.set_global("random_int",async function(...args) {
    ...
    await (async function ()  {
         return  await Environment.set_global("resolve_multi_path",async function(path,obj,not_found) {
             return  await async function(){
    ...
    await (async function ()  {
         return  await Environment.set_global("symbol_tree",async function(quoted_form,_state,_current_path) {
            let acc;
            let allocators;
            let uop;
            let get_allocations;
    ...
    await (async function ()  {
         return  await Environment.set_global("except_nil",async function(items) {
            let acc=[];
            ;
    ...
    await (async function ()  {
         return  await Environment.set_global("each",async function(items,property) {
             return  await async function(){
    ...
    await (async function ()  {
         return  await Environment.set_global("replace",async function(...args) {
    ...
    await (async function ()  {
         return  await Environment.set_global("cl_encode_string",async function(text) {
            if (check_true ((text instanceof String || typeof text==='string'))){
                let escaped;
                let nq;
                let step1;
    ...
    await (async function ()  {
         return  await Environment.set_global("path_to_js_syntax",async function(comps) {
    ...
    await (async function ()  {
         return  await Environment.set_global("first_is_upper_case?",async function(str_val) {
            {
    ...
    await (async function ()  {
         return  await Environment.set_global("safe_access_2",async function(token,ctx,sanitizer_fn) {
            let comps;
            let acc;
            let acc_full;
            let pos;
    ...
    await (async function ()  {
         return  await Environment.set_global("form_structure",async function(quoted_form,max_depth) {
            let idx;
            let acc;
            let structure;
            let follow_tree;
    ...
    await (async function ()  {
         return  await Environment.set_global("compiler_source_chain",async function(cpath,tree,sources) {
    ...
    await (async function ()  {
         return  await Environment.set_global("symbols",async function() {
    ...
    await (async function ()  {
         return  await Environment.set_global("is_value?",async function(val) {
            if (check_true ((val===""))){
                  return true
            } else {
    ...
    await (async function ()  {
         return  await Environment.set_global("and*",async function(...vals) {
    ...
    {
         return  await Environment.set_global("either",async function(...args) {
            let rval;
            rval=null;
            await (async function() {
